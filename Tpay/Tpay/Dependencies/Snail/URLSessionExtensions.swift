...
extension URLSession {
    ...
    func decoded<T: Codable>(request: URLRequest) -> Observable<(T, URLResponse)> {
    ...
    func dictionary(request: URLRequest) -> Observable<([String: Any], URLResponse)> {
    ...
    func array(request: URLRequest) -> Observable<([Any], URLResponse)> {
    ...
    #if os(iOS) || os(tvOS)
    func image(request: URLRequest) -> Observable<(UIImage, URLResponse)> {
