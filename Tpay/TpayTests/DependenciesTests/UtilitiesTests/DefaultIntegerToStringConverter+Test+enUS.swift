...
final class DefaultIntegerToStringConverter_Tests_enUS: XCTestCase {
    
    // MARK: - Properties
    
    private let sut = DefaultIntegerToStringConverter(locale: .enUS)
    ...
    func test_StringFrom_1_000() {
        expect(self.sut.string(from: 1_000)) == "1,000"
    }
